...
import com.example.student_service.service.MoodleService;
...
public class MoodleController {
    ...
    public String handleFileUpload(@RequestParam(value = "type", required = false) String type,
                                   ...
                                   HttpSession session) {
        try {
            List<Student> students = moodleService.importStudentsFromExcel(file.getInputStream());
    ...
    public ResponseEntity<byte[]> downloadFile(@PathVariable String format,
        ...
        try {
            byte[] fileContent = moodleService.generateExportFile(students, format);
